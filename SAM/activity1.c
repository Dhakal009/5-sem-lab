// write a program to test either the given random numbers are uniformly distributed or not. Use chi square test to check the uniformity of the generated random numbers.
